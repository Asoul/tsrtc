...
之前週末證交所突然換了api，query 要改了一些東西，已經都更新了，主要是原本的 `tse_1101.tw` 之類的字串，後面要加上當天日期變成 `tse_1101.tw_20150624`，然後最後要加上一個格林威治時間的 long `&_=1435133420488` 就可以正常 query 了。

這幾天期末沒有顧到，所以中間 6/19 到今天沒有紀錄到，感謝好心人事寄信提醒，各位的支持是我最大的動力，謝謝大家。
